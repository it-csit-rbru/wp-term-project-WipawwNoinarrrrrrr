    ...
    <body>        
        <div class="container">
            ...
            <div class="row">
                ...
                <h4>เพิ่มรุ่นกล้อง</h4>    
                <?php
                    if(isset($_GET['submit'])){
                        $Resolution_name = $_GET['Resolution_name'];
                        $sql = "insert into resolution (Resolution_name) values ('$Resolution_name')";
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มรุ่นกล้อง $Resolution_name เรียบร้อยแล้ว<br>";
                        echo '<a href="Resolution_list.php">แสดงรุ่นกล้องทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="Resolution_add" action="<?php echo $_SERVER['PHP_SELF']?>">
