    ...
    <body>        
        <div class="container">
            ...
            <div class="row">
                ...
                <h4>เพิ่มข้อมูลเพศ</h4>    
                <?php
                    if(isset($_GET['submit'])){
                        $Soundtrack_name = $_GET['Soundtrack_name'];
                        $sql = "insert into soundtrack (Soundtrack_name) values ('$Soundtrack_name')";
                ...
                ?>
                    <form class="form-horizontal" role="form" name="Soundtrack_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="Soundtrack_name" class="col-md-2 col-lg-2 control-label">เพศ</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="Soundtrack_name" id="Soundtrack_name" class="form-control">
                            </div>    
                        </div>
                        <div class="form-group">
                            <div class="col-md-10 col-lg-10">
